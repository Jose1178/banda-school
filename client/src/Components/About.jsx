    ...
    <div className="bg-slate-300">
      ...
      <div className="px-20 text-left">
        ...
        <div className="flex flex-row justify-around mt-4 border border- 2 border-slate-400 py-2 rounded-lg bg-slate-300">
          <div class="max-w-sm p-6 bg-slate-300 border border-slate-600 rounded-lg shadow">
            <svg
              class="w-10 h-10 mb-2 text-green-700"
              aria-hidden="true"
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <div class="max-w-sm p-6 bg-slate-300 border border-slate-600 rounded-lg shadow">
            ...
            <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">
              Get info on past classes, this is not to encourage to to miss classes.
              Contact the administrator at this email below.
            </p>
